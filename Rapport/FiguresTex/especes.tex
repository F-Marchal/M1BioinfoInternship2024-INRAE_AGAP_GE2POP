...
\begin{table}[ht]
    ...
    \label{tab:Especes}
    \redbracket{Si les modes de reproduction des espèces de l'\gls{outgroup} sont connus, pouvez-vous me les communiquer pour que je les rajoute au tableau ? De même si le nombre d'individus utilisé est connu.}
    }
